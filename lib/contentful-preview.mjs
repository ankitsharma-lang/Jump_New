...
export function formatTimelineTimestamp(value) {
  ...
  // Keep server and client output identical. A locale-dependent value here causes
  // React hydration failures when Vercel and the editor use different timezones.
